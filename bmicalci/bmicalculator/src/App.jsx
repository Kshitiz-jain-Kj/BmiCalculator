...
const App = () => {
  ...
  return (
    <div className=" text-white h-screen w-screen flex justify-center items-center bg-black-100 ">
     <div>
      <h1 className='text-4xl font-semi-bold'>BMI CALCULATOR</h1>
      <div>
        <label htmlFor="weight">Weight (kg)</label>

        <input type="number"  className='bg-gray-800 rounded-md ml-3 mt-4 ' onChange={(e)=>setWeight(e.target.value)}/>
      </div>
      <div>
        <label htmlFor="weight">Height (m)</label>

        <input type="number"  className='bg-gray-800 rounded-md ml-5 mt-4'onChange={(e)=>setHeight(e.target.value)}/>
      </div>
